            ...
            <div class="relative">
                ...
                <div class="user-panel p-3 light mb-2">
                    <div>
                        ...
                        <h6 class="font-weight-light mt-2 mb-1">Hello, {{Auth::user()->name}}</h6>
                    ...
                    <div class="collapse multi-collapse" id="userSettingsCollapse">
                        <div class="list-group mt-3 shadow">
                            ...
                            <a href="/auth/changepassword" class="list-group-item list-group-item-action"><i
                                    class="mr-2 fas fa-key text-purple"></i>Change Password</a>
                        </div>
                    </div>
                </div>
            </div>
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a href="/dashboard">
                    <i class="icon fas fa-chart-line purple-text"></i> <span>Dashboard</span> 
                        ...
                        <li class="treeview"><a href="/company"><i class="icon fas fa-mail-bulk blue-text"></i> <span>Company</span></a>
                        </li>
                        <li class="treeview"><a href="/userconfig"><i class="icon fas fa-user-cog"></i> Admin Configuration</a>
                        </li>
                        {{-- <li class="treeview"><a href="/news"><i class="icon far fa-newspaper green-text"></i> News</a>
                        </li>
                        <li class="treeview"><a href="#"> <i class="icon amber-text fas fa-project-diagram"></i> Tender<i
                        class="icon icon-angle-left s-18 pull-right"></i></a>
                            <ul class="treeview-menu"> --}}
                            {{-- <li><a href="/tender"><i class="icon pink-text fas fa-briefcase"></i> Your Tender <span class="badge r-3 badge-primary pull-right">1</span></a></li> --}}
                            {{-- <li><a href="/tender"><i class="icon pink-text fas fa-briefcase"></i> Your Tender <span class="badge r-3 badge-primary pull-right">{{$jumlahtender}}</span></a></li> --}}

                                    {{-- <li><a href="/tender/rup"><i class="icon text-light-blue fas fa-plus"></i> Add RUP </a></li> --}}
                                </ul>
                        </li>
                        {{-- <li class="treeview"><a href="/tender"><i class="icon icon-folder5"></i>Tender</a> --}}
                        </li>
                        {{-- <li class="treeview"><a href="/about-us"><i class="icon fas fa-address-card "></i> About Us</a> --}}
                        </li>
                </li>
                {{-- <li class="treeview"><a href="/changepassword"> <i class="icon icon-sailing-boat-water purple-text s-18"></i> Change Password</a></li> --}}
                ...
                {{-- <li class="treeview"><a href="#"><i class="icon fas fa-users"></i> Vendor<i
                        class="icon icon-angle-left s-18 pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="/vendor"><i class="icon fas fa-users"></i> Vendor Profile <span class="badge r-3 badge-primary pull-right">5</span></a>
                            <li><a href="/vendor"><i class="icon fas fa-users"></i> Vendor Profile <span class="badge r-3 badge-primary pull-right">{{$jumlahvendor1}}</span></a>
                        </li>
                    </ul>
                </li> --}}
